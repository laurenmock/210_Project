...
barplot(tab1,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Donor Blood Type",
        col=c("#990000","yellow"),
        cex.main = 1,
        legend=rownames(tab1),
        args.legend=list(x="topleft"), beside=T)
...
barplot(tab2,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Recipient Age Range",
        cex.main = 1,
        col=c("#990000","yellow"),
...
barplot(tab3,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Recipient Blood Type",
        col=c("#990000","yellow"),
        cex.main = 1,
...
barplot(tab4,
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Recipient Disease",
        cex.main = 1,
        las = 2,
        col=c("#990000","yellow"),
...
barplot(tab5,
        xlab='CMV Status', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Serological Compatibility",
        cex.main = 1,
        col=c("#990000","yellow"),
...
barplot(tab7,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Antigen Difference", 
        cex.main = 1,
        col=c("#990000","yellow"),
...
barplot(tab8,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Allele Difference",
        cex.main = 1,
        col=c("#990000","yellow"),
...
barplot(tab9,
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Difference Type", 
        cex.main = 1,
        cex.axis = 0.1,
        las = 2,
        col=c("#990000","yellow"),
        legend=rownames(tab9),
        args.legend=list(x="topleft"), beside=T)
...
barplot(tab10,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Donor Age Range", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab10),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab11,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Donor CMV Status",
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab11),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab13,
        xlab='Recipient Rh Presence',
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Recipient rh Presence",
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab13),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab14,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Recipient CMV Presence", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab14),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab15,
        xlab='Disease Group', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Disease Group", 
        col=c("#990000","yellow"),
        cex.main=1,
        legend=rownames(tab15),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab16,
        xlab='Gender Match', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Gender Match?", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab16),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab17,
        xlab='Match based on Blood Group', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Match of Blood Group", 
        col=c("#990000","yellow"),
        cex.main=1,
        legend=rownames(tab17),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab18,
        xlab='Match based on HLA', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Match of HLA", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab18),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab19,
        xlab='Risk Group', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Risk Group", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab19),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab20,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Stem Cell Source", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab20),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab21,
        ...
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Treatment(2) after 1st Relapse", 
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab21),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab22,
        xlab='Development of Acute GVHD stage II, III or IV ',
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Acute GVHD (Stage II, III or IV)",
        col=c("#990000","yellow"),
        cex.main=1,
        legend=rownames(tab22),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab23,
        xlab='Development of Acute GVHD stage III or IV ',
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Acute GVHD (Stage III or IV)", 
        col=c("#990000","yellow"),
        cex.main=1,
        legend=rownames(tab23),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab24,
        xlab='Development of Chronic Acute GVHD', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Chronic Acute GVHD",
        col=c("#990000","yellow"),
        cex.main=1,
        legend=rownames(tab24),
        args.legend=list(x="bottomleft"), beside=T)
...
barplot(tab25,xlab='Relapse', 
        ylab='Survival = Yellow, Death = Red',
        main="Survival by Relapse",
        cex.main=1,
        col=c("#990000","yellow"),
        legend=rownames(tab25),
        args.legend=list(x="bottomleft"),beside=T)
